...
class Notifications with ChangeNotifier {
  ...
  Future<void> fetchAndSetNotifications(String userId) async {
    ...
    var url = Uri.parse(
        'https://bediningboard-default-rtdb.firebaseio.com/notifications.json?auth=$authToken');
    try {
  ...
  Future<void> deleteNotification(String id) async {
    final url = Uri.parse(
        'https://bediningboard-default-rtdb.firebaseio.com/notifications/$id.json?auth=$authToken');
